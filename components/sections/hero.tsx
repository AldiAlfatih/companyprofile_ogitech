...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-fit lg:min-h-[85vh] bg-background">
      <AuroraBackground className="flex-col pt-16 pb-6 sm:pt-28 sm:pb-16 min-h-fit lg:min-h-[85vh]">
        ...
        <motion.div
          ...
          className="relative z-10 mt-6 pb-2 sm:mt-12 sm:pb-8 flex flex-col items-center gap-2 cursor-pointer"
          onClick={() => scrollTo('portfolio')}
        >
